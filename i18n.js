...
(function () {
  ...
  window.bpmI18nAdd({
    ...
    'side.analyst': '您的分析師 · Your analyst', 'side.analystTitle': '資深分析師 · 大中華區',
    'foot.confidential': '機密', 'foot.sources': '資料來源：託管行、世邦魏理仕、戴德梁行、內部模型', 'foot.copyright': '© 2026 BPM Capital Partners',
    ...
    'side.analyst': 'Your analyst', 'side.analystTitle': 'Senior analyst · Greater China',
    'foot.confidential': 'Confidential', 'foot.sources': 'Sources: custodian, CBRE, Cushman & Wakefield, internal models', 'foot.copyright': '© 2026 BPM Capital Partners',
